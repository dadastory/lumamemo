...
LumaMemo supports multiple storage backends to save your photos and thumbnails. This document will detail how to configure different storage providers.
...
NUXT_STORAGE_PROVIDER=openlist
NUXT_PROVIDER_OPENLIST_BASE_URL=https://your-openlist-server.com
NUXT_PROVIDER_OPENLIST_ROOT_PATH=/local/lumamemo
NUXT_PROVIDER_OPENLIST_TOKEN=your-static-token
```
